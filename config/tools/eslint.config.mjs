...
export default tseslint.config(
  ...
  eslintPluginUnicorn.configs.recommended,
  {
    ...
    rules: {
      ...
      'unicorn/prevent-abbreviations': 'warn', // Too strict for our codebase
      ...
      'architectural-rules/require-duration-tracking': 'error',
      'architectural-rules/no-console-in-production': 'error',
