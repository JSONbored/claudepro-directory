...
<RelatedResources
  ...
  resources={[
    {
      title: "Risk Management Use Cases",
      description: "Advanced risk modeling with Monte Carlo simulations for enhanced portfolio protection and faster assessments.",
      url: "/guides/use-cases",
      type: "guide"
    },
    {
      title: "Compliance Automation", 
      description: "Complete compliance workflow for FINRA and SEC requirements. Reduces review time from days to hours with full audit trails.",
      url: "/guides/use-cases",
      type: "guide"
    },
    {
      title: "MCP Integration Tutorial",
      description: "Step-by-step MCP setup guide with configuration examples and troubleshooting.",
      url: "/guides/tutorials/desktop-mcp-setup",
      type: "tutorial"
    },
    {
      title: "Integration Troubleshooting",
      description: "Common integration issues and solutions for financial platforms. Comprehensive problem-solving for enterprise deployments.",
      url: "/guides/troubleshooting",
      type: "guide"
    },
    {
      title: "Security Configuration Guide",
      description: "Complete workflow for SOC 2 and ISO 27001 compliance. End-to-end security setup for financial institutions.",
      url: "/guides/workflows",
      type: "guide"
    },
    {
      title: "Community Resources",
      description: "Real implementations from financial institutions. See variations for different sectors with specific adaptations.",
      url: "/community",
      type: "example"
    }
  ]}
