...
|------------|----------|--------------|------------|
| undefined | discord | bot, community | ~5 mins |
| undefined | customer-support | intercom, chat | ~5 mins |

## Implementation Guide

### Step 1: Choose Your MCP Server

Based on your specific needs for team communication, we recommend starting with **undefined**.
