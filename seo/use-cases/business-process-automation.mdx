  ...
  resources={[
    {
      ...
      description: "Step-by-step guide for setting up Claude Desktop. Includes configuration and integration examples.",
      url: "/guides/tutorials/desktop-mcp-setup",
      type: "tutorial"
    },
    {
      title: "AI Tool Comparisons",
      description: "Detailed comparison of enterprise AI platforms. Evaluates security, integration, and ROI across implementations.",
      url: "/guides/comparisons",
      type: "guide"
    },
    {
      title: "MCP Server Setup Guide",
      description: "Technical tutorial for deploying Model Context Protocol servers. Covers Docker deployment and custom connector development.",
      url: "/guides/tutorials/desktop-mcp-setup",
      type: "tutorial"
    },
    {
      title: "Troubleshooting Guide",
      description: "Common security issues and solutions for enterprise AI. Comprehensive problem-solving for compliance challenges.",
      url: "/guides/troubleshooting",
      type: "guide"
    },
    {
      title: "Financial Services AI Workflow",
      description: "Complete workflow for financial automation with Claude. End-to-end process for regulatory-compliant implementations.",
      url: "/guides/use-cases/financial-services-guide",
      type: "guide"
    },
    {
      title: "Enterprise Success Stories",
      description: "Real implementations from Fortune 500 companies. Detailed case studies with metrics and lessons learned.",
      url: "/community",
      type: "example"
    }
  ]}
