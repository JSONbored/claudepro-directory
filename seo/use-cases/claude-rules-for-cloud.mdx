...
| undefined | aws | cloud, architecture | Simple |
| undefined | devops | sre, kubernetes | Advanced |

## Implementation Guide

### Step 1: Choose Your Rule

Based on your specific needs for cloud architecture, we recommend starting with **undefined**.
