...
description: "Learn how to install, configure, and optimize MCP servers for Claude Desktop with step-by-step instructions and best practices for 2025"
keywords: 
  - "Claude MCP server"
  - "MCP server setup"
...
<InfoBox title="System Requirements" variant="important">
...
<Callout type="warning" title="Common Configuration Errors">
  If your MCP server isn't working, check these common issues:
</Callout>

<InfoBox title="Troubleshooting Checklist" variant="warning">
...
<InfoBox title="Pro Tip" variant="info">
  ...
  resources={[
    {
      ...
      description: "Complete reference for the Model Context Protocol",
    ...
    {
      title: "Claude Desktop Advanced Configuration",
      description: "Deep dive into Claude Desktop settings",
