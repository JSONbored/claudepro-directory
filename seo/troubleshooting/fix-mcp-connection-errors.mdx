...
<RelatedResources
  ...
  resources={[
    {
      title: "MCP Server Installation Errors",
      description: "NPM permission errors and installation failures. Common when setting up new MCP servers.",
      url: "/guides/troubleshooting/mcp-installation-errors",
      type: "guide"
    },
    {
      title: "Claude Desktop Performance Issues", 
      description: "Memory leaks and slow performance problems. Often occurs with multiple MCP servers.",
      url: "/guides/troubleshooting/claude-performance-optimization",
      type: "guide"
    },
    {
      title: "Official MCP Documentation",
      description: "Model Context Protocol specifications from Anthropic with comprehensive technical details.",
      url: "https://github.com/modelcontextprotocol/specification",
      type: "documentation",
      external: true
    },
    {
      title: "Advanced MCP Debugging",
      description: "Protocol-level debugging guide for complex scenarios and system-level issues.",
      url: "/guides/workflows/advanced-mcp-debugging",
      type: "guide"
    },
    {
      title: "Community Support Forum",
      description: "GitHub Discussions for MCP issues and user-shared solutions.",
    ...
    },
    {
      ...
      description: "Comprehensive guide to preventing common Claude Desktop issues and maintaining optimal performance.",
