  ...
  errors={[
    {
      ...
      description: "OAuth callback handling failure after browser authentication. Corporate networks blocking OAuth callbacks require API key fallback.",
      solution: "Remove all Claude directories (~/.claude, ~/.npm-global/lib/node_modules/@anthropic-ai/). Clear npm cache. Reinstall fresh.",
      code: "AUTH_001"
    },
    {
      error: "Missing API key · Run /login",
      description: "Token storage limitations in SSH environments. Config mismatches between installation methods.",
    ...
    },
    {
      ...
      description: "File access patterns misconfigured. Security rules blocking legitimate operations.",
      solution: "Configure permission scopes: Read(src/**), Edit(/docs/**), Deny(~/.env)",
      code: "PERM_001"
    },
    {
      error: "MCP server connection failed",
      description: "Stack Overflow integration requires dedicated environment variables. Rate limiting exceeded.",
...
<RelatedResources
  ...
  resources={[
    {
      title: "Claude Code MCP Server Integration Errors",
      description: "Debug Model Context Protocol server connections for GitHub, Stack Exchange, and filesystem access. Common when extending Claude's capabilities.",
      url: "/guides/troubleshooting/claude-code-mcp-server-errors",
      type: "guide"
    },
    {
      title: "Claude Code Performance Optimization", 
      description: "Resolve slow response times, memory issues, and processing delays. Often occurs with large codebases or complex projects.",
      url: "/guides/troubleshooting/claude-code-performance-issues",
      type: "guide"
    },
    {
      title: "Official Claude Code Documentation",
      description: "Comprehensive technical reference from Anthropic with API specifications and configuration details.",
    ...
    },
    {
      ...
      description: "Advanced deployment strategies for large teams including CI/CD integration and container orchestration.",
      url: "/guides/workflows/claude-code-enterprise-deployment",
      type: "guide"
    },
    {
      title: "Claude Community Support Forum",
      description: "Active community forum for troubleshooting help and user-contributed solutions.",
      url: "https://community.anthropic.com/c/claude-code",
      type: "documentation",
      external: true
    },
    {
