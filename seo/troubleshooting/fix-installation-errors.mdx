...
<RelatedResources
  ...
  resources={[
    {
      title: "Configure MCP Servers for Claude Code",
      description: "Set up filesystem, GitHub, and memory servers. Enable local file access and repository integration in 20 minutes.",
      url: "/guides/tutorials/claude-mcp-server-setup",
      type: "tutorial"
    },
    {
      title: "Fix Claude Desktop MCP Server Errors", 
      description: "Troubleshoot error -32000 and connection issues. Master MCP debugging and protocol understanding.",
      url: "/guides/troubleshooting/claude-mcp-server-errors",
      type: "guide"
    },
    {
      title: "Claude Code Configuration Guide",
      description: "Production-ready setup with CLAUDE.md files. Configure Claude Code for team usage.",
      url: "/guides/tutorials/desktop-mcp-setup",
      type: "guide"
    },
    {
      title: "Node.js Documentation",
      description: "Official Node.js documentation for version management and installation.",
      url: "https://nodejs.org/docs",
      type: "documentation",
      external: true
    },
    {
      title: "WSL Setup Tutorial",
      description: "Complete Windows Subsystem for Linux setup. Unix environment on Windows machines.",
      url: "/guides/tutorials/wsl-setup-guide",
      type: "guide"
    },
    {
      title: "Community Installation Examples",
      description: "User-submitted solutions and platform variations. Learn from community experiences.",
      url: "/community",
      type: "example"
    }
  ]}
