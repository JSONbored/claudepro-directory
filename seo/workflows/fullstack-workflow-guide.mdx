...
### 2. Frontend Agent
**Recommended:** [Backend Architect Agent](/agents/backend-architect-agent)

Role: User interface


### 3. Database Agent
**Recommended:** [Database Specialist Agent](/agents/database-specialist-agent)

Role: Data modeling


### 4. Testing Agent
**Recommended:** [Frontend Specialist Agent](/agents/frontend-specialist-agent)
