...
[View Configuration](/agents/frontend-specialist) | [Copy Config](javascript:void(0))
...
[View Configuration](/agents/ui-ux-design-expert) | [Copy Config](javascript:void(0))
...
|-------|-----------|------------|----------|
| **Frontend Specialist** | frontend | ⭐⭐⭐ Advanced | react |
| **Performance Optimizer** | performance | ⭐⭐⭐ Advanced | optimization |
| **UI/UX Design Expert** | ui | ⭐⭐ Moderate | ux |
...
- Most popular: **Frontend Specialist**
- Fastest growing: **Performance Optimizer**
- Hidden gem: **UI/UX Design Expert**
