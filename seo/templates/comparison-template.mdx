...
<RelatedResources
  ...
  resources={[
    {
      title: "[RESEARCH: Tool A] Official Documentation",
      description: "Complete feature documentation, pricing, and setup guides from [RESEARCH: Company].",
      url: "[RESEARCH: Actual documentation URL]",
      type: "documentation",
      external: true
    },
    {
      title: "[RESEARCH: Tool B] User Guide", 
      description: "Official user guide, tutorials, and best practices from [RESEARCH: Company].",
      url: "[RESEARCH: Actual guide URL]",
      type: "documentation",
      external: true
    },
    {
      title: "Claude Documentation",
      description: "Anthropic's official Claude documentation, API references, and implementation guides.",
      url: "https://docs.anthropic.com",
      type: "documentation",
      external: true
    },
    {
      title: "[RESEARCH: Independent Review/Study]",
      description: "[RESEARCH: Description of third-party analysis or review that exists]",
      url: "[RESEARCH: Actual review URL]",
      type: "guide",
      external: true
    },
    {
      title: "Claude Implementation Tutorial",
      description: "Step-by-step tutorial for implementing Claude in your workflow.",
      url: "/guides/tutorials/claude-implementation",
      type: "tutorial"
    },
    {
      title: "AI Tool Selection Guide",
      description: "Framework for evaluating and selecting AI tools for your organization.",
      url: "/guides/workflows/ai-tool-selection",
      type: "guide"
    }
  ]}
/>
