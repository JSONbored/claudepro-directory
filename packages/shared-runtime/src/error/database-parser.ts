...
// Import enums directly from the generated file (not via index.ts which Prisma doesn't generate)
// Using the /prisma/enums export path which exists in package.json and is generated by Prisma
import { content_category as ContentCategory, guide_subcategory as GuideSubcategory } from '@heyclaude/database-types/prisma/enums';
 ...
 * These match the enums in @heyclaude/database-types/prisma/enums.ts
 */
