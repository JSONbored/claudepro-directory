...
import type { GetSearchSuggestionsInput } from '../../lib/types.js';
...
export async function handleGetSearchSuggestions(
  ...
  try {
    ...
    logger.info('getSearchSuggestions completed successfully', {
    ...
    logger.error('getSearchSuggestions tool error', normalized, {
      tool: 'getSearchSuggestions',
      query,
      limit,
    });
