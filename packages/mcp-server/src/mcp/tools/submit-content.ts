...
import type { SubmitContentInput } from '../../lib/types.js';
...
export async function handleSubmitContent(
  ...
  try {
    ...
    logger.info('submitContent completed successfully', {
      tool: 'submitContent',
    ...
    logger.error('submitContent tool error', normalized, { tool: 'submitContent' });
    throw normalized;
  }
}
