...
import type { GetSocialProofStatsInput } from '../../lib/types.js';
...
export async function handleGetSocialProofStats(
  ...
  try {
    ...
    logger.info('getSocialProofStats completed successfully', {
    ...
    logger.error('getSocialProofStats tool error', normalized, { tool: 'getSocialProofStats' });
    throw normalized;
  }
}
