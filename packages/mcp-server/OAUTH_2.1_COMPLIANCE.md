...
3. **✅ Exact Redirect URI Matching** - **REQUIRED**
   - ✅ Validates redirect_uri protocol (http/https only)
...
9. **✅ Token Endpoint** - **REQUIRED**
   ...
   - ✅ Validates required parameters (code, redirect_uri, client_id, code_verifier)
...
10. **✅ HTTPS Enforcement** - **REQUIRED**
    - ✅ Validates redirect_uri uses http/https protocol
