...
if (typeof process !== 'undefined' && process.env) {
  ...
  void Promise.resolve()
    .then(function () {
      return require('@heyclaude/shared-runtime/infisical/cache');
    })
    .then(function (cacheModule) {
...
exports.prisma =
  (_a = globalForPrisma.prisma) !== null && _a !== void 0
    ...
    : (function () {
        ...
        var projectRef =
          (projectRefMatch === null || projectRefMatch === void 0 ? void 0 : projectRefMatch[1]) ||
          'unknown';
        if (
          env_1.env.NODE_ENV === 'development' ||
          env_1.env.PRISMA_DEBUG === 'true' ||
          env_1.env.PRISMA_DEBUG === '1'
        ) {
          shared_runtime_1.logger.info(
            { projectRef: projectRef },
            '[Prisma Client] Connecting to Supabase project'
          );
        }
            ...
            fetch('http://127.0.0.1:7242/ingest/a6ff234e-b9b0-4505-81c3-e5b21fd3c031', {
              ...
              body: JSON.stringify({
                ...
                data: {
                  isTest: isTest,
                  dbUrl: !!dbUrl,
                  PrismaClientName: client_1.PrismaClient.name,
                  PrismaClientType: typeof client_1.PrismaClient,
                  PrismaClientIsFunction: typeof client_1.PrismaClient === 'function',
                },
                timestamp: Date.now(),
                sessionId: 'debug-session',
                runId: 'run1',
          ...
          if (typeof process !== 'undefined' && process.env) {
            fetch('http://127.0.0.1:7242/ingest/a6ff234e-b9b0-4505-81c3-e5b21fd3c031', {
              ...
              body: JSON.stringify({
                ...
                data: {
                  clientType: client_2.constructor.name,
                  clientPrototype: Object.getPrototypeOf(client_2).constructor.name,
                  hasReset: typeof client_2.reset === 'function',
                  clientKeys: Object.keys(client_2).slice(0, 10),
                },
                timestamp: Date.now(),
                sessionId: 'debug-session',
                runId: 'run1',
        ...
        if (typeof process !== 'undefined' && process.env) {
          fetch('http://127.0.0.1:7242/ingest/a6ff234e-b9b0-4505-81c3-e5b21fd3c031', {
            ...
            body: JSON.stringify({
              ...
              data: { isTest: isTest, clientType: client.constructor.name },
              timestamp: Date.now(),
              sessionId: 'debug-session',
              runId: 'run1',
              hypothesisId: 'E',
