 ...
 */
export function notFoundResponse(message?: string, resourceType?: string): NextResponse {
  const defaultMessage = resourceType ? `${resourceType} not found` : 'Resource not found';
