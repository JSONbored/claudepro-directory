...
import { HeyClaudeEmailLogo } from './components/heyclaude-logo';
...
/**
 * Render any email template component or element to HTML using React Email's `render`.
...
export async function renderEmailTemplate<TProps>(
  ...
  const Component = template as React.ComponentType<Record<string, unknown>>;
