    ...
    >
      <Section style={heroShellStyle}>
        ...
        <Text style={heroSubtitleStyle}>
          Every Monday we&apos;ll deliver the most-loved agents, MCP servers, and actionable
          playbooks from the claudepro.community—curated, tested, and ready to ship.
        </Text>
      ...
      <Section style={spotlightSectionStyle}>
        ...
        <Text style={spotlightDescriptionStyle}>
          Expect teardown videos, MCP recipes, and scripts you can clone instantly. You&apos;re
          joining a creator community that openly shares the good stuff.
        </Text>
      </Section>
