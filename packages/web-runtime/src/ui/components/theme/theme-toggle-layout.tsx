...
export function ThemeToggleLayout({
  ...
  return (
    <motion.button
      ...
      className={cn(
        'focus-visible:ring-ring focus-visible:ring-offset-background relative inline-flex h-7 w-14 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent p-1 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
    ...
    >
      <motion.div
        className="bg-background pointer-events-none block h-5 w-5 rounded-full shadow-lg ring-0"
        layout
