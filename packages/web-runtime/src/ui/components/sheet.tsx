  ...
  'fixed z-[61] gap-4 bg-background p-6 shadow-lg transition ease-in-out will-change-transform contain-paint data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
        ...
        left: 'top-[50%] left-0 -translate-y-1/2 max-h-[85vh] w-3/4 border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm rounded-r-xl',
        right:
          'top-[50%] right-0 -translate-y-1/2 max-h-[85vh] w-3/4 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm rounded-l-xl',
      },
    },
    defaultVariants: {
      side: 'right',
