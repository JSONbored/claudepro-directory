...
/**
 * Sliding Number Component
 * Premium digit-by-digit sliding animation for counters
 *
 * Based on shadcn/ui sliding-number component with Motion.dev spring physics
 * Each digit slides independently for a polished, premium effect
 *
  ...
  useEffect(() => {
    if (forwardedRef) {
      if (typeof forwardedRef === 'function') {
        ...
        (forwardedRef as React.MutableRefObject<HTMLSpanElement | null>).current = localRef.current;
      }
    }
  }, [forwardedRef]);
