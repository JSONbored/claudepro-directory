...
export const gradient = {
   ...
   */
  heroTexture:
    'bg-[radial-gradient(circle_at_20%_50%,var(--claude-orange)_0%,transparent_50%),radial-gradient(circle_at_80%_80%,var(--claude-orange)_0%,transparent_50%)] bg-[length:100%_100%] bg-center',
} as const;
