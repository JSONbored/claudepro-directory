    ...
    .array(
      z.object({
        ...
        search_count: z
          ...
          .int()
          .optional()
          .describe('Number of searches for this suggestion'),
    ...
    .array(
      z.object({
        ...
        content_count: z
          ...
          .int()
          .optional()
          .describe('Number of content items in this category'),
 ...
 */
export const contentDetailResponseSchema = contentItemSchema
  .extend({
 ...
 */
export const categoryConfigItemSchema = z
  .object({
 ...
 */
export const changelogEntryResponseSchema = z
  .string()
  .describe('Changelog entry in LLMs.txt format');
...
export const socialProofStatsResponseSchema = z.object({
  ...
  timestamp: z
    .string()
    .datetime()
    .describe('Response timestamp (ISO 8601)')
  ...
  meta: z
    .object({
      generated: z
        .string()
        .datetime()
        .describe('Generation timestamp (ISO 8601)')
        .meta({ format: 'date-time' }),
 ...
 */
export const inngestResponseSchema = z
  .unknown()
  .describe('Inngest function response (varies by function)');
