 ...
 * ```
 */
export function parseCategoryParam(value: string | string[] | undefined): content_category | null {
 ...
 * ```
 */
export function parseOffsetParam(value: string | undefined, default_ = 0): number {
  if (!value) return default_;
 ...
 * ```
 */
export function parseBooleanParam(value: string | boolean | undefined, default_ = false): boolean {
 ...
 * ```
 */
export function parseStringArrayParam(value: string | string[] | undefined): string[] {
  if (!value) return [];
