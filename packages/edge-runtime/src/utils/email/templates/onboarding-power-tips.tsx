...
const BEST_PRACTICES = [
	{
		title: "Start Small",
		description: "Master one configuration before combining multiple tools.",
	},
	{
		title: "Document Everything",
		description: "Keep notes on which setups work best for each task.",
	},
	{
		title: "Iterate Often",
		description: "Refine prompts and rules based on real results.",
	},
	{
		title: "Share Back",
		description: "Submit your winning configurations to help the community.",
	},
] as const;
...
export function OnboardingPowerTips({ email }: OnboardingPowerTipsProps) {
	...
	return (
		<BaseLayout
			preview="Power User Tips - Advanced Claude Techniques & Best Practices"
			utm={utm}
		>
			<HeroBlock
