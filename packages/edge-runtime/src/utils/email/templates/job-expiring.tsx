...
import { formatEmailDate, pluralize } from "@heyclaude/edge-runtime/utils/email/formatters.ts";
...
export function JobExpiring(props: JobExpiringProps) {
	const { jobTitle, company, jobId, expiresAt, daysRemaining, renewalUrl } =
		props;
						...
						? [
								{
									...
									overrides: {
										href: renewalUrl,
										label: "Renew Listing ($99)",
										contentKey: "renewal_cta",
									},
								},
							]
						: []),
...
export async function renderJobExpiringEmail(
	props: JobExpiringProps,
): Promise<string> {
