...
export function JobRejected(props: JobRejectedProps) {
	const { jobTitle, company, jobId, rejectionReason } = props;
		...
		>
			<Section style={contentSection}>
				...
				<Text style={subheadingStyle}>
					We've reviewed your job posting and it needs some adjustments before
					we can publish it.
				</Text>
			</Section>
			...
			<Section style={contentSection}>
				<Text style={paragraphStyle}>
					Please review the feedback above, make the necessary updates, and
					resubmit your listing. We're here to help you get published!
				</Text>
			</Section>
				...
				buttons={[
					{
						...
						overrides: {
							href: editUrl,
							label: "Edit Job Listing",
							contentKey: "edit_job_cta",
						},
					},
				]}
			/>
...
export async function renderJobRejectedEmail(
	props: JobRejectedProps,
): Promise<string> {
