    ...
    >
      ...
      <Section style={contentSection}>
        <Text style={paragraphStyle}>
          <strong style={strongStyle}>Category:</strong> {category.charAt(0).toUpperCase() + category.slice(1)}
        </Text>
        <Text style={paragraphStyle}>
      ...
      <Section style={contentSection}>
        ...
        <div style={messageBoxStyle}>
          {message.split('\n').map((line, i) => (
            <Text key={i} style={messageLineStyle}>{line || '\u00A0'}</Text>
          ))}
        </div>
      </Section>
      ...
      <Section style={contentSection}>
        ...
        <ul style={listStyle}>
          ...
          <li style={listItemStyle}>
            Mark as responded once handled
          </li>
        </ul>
      </Section>
    </BaseLayout>
...
export function renderContactSubmissionAdminEmail(props: ContactSubmissionAdminProps) {
