    ...
    >
      <Section style={contentSection}>
        ...
        <Text style={subheadingStyle}>
          We've received your <strong>{category}</strong> message via our terminal.
        </Text>
      </Section>
      ...
      <Section style={contentSection}>
        ...
        <div style={linkGridStyle}>
          <a
            href={buildEmailCtaUrl(`${baseUrl}/help`, utm, { content: 'help_center' })}
            style={linkCardStyle}
          >
            📚 Help Center
          </a>
          <a
            href={buildEmailCtaUrl('https://github.com/JSONbored/claudepro-directory/discussions', utm, { content: 'discussions' })}
            style={linkCardStyle}
          >
            💬 Community Discussions
          </a>
          <a
            href={buildEmailCtaUrl('https://discord.gg/Ax3Py4YDrq', utm, { content: 'discord' })}
            style={linkCardStyle}
          >
            👋 Join Discord
          </a>
      ...
      <Section style={contentSection}>
        <Text style={footerNoteStyle}>
          If you need urgent assistance, our Discord community is the fastest way to get help!
        </Text>
      </Section>
    </BaseLayout>
  );
...
export function renderContactSubmissionUserEmail(props: ContactSubmissionUserProps) {
