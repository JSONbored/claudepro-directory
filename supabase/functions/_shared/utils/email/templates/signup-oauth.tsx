		...
		>
			<Section style={heroShellStyle}>
				...
				<Text style={heroTitleStyle}>
					Welcome to{" "}
					<span style={heroHighlightStyle}>Claude Pro Directory</span>
				</Text>
				<Text style={heroSubtitleStyle}>
					Your account is ready! Start exploring 300+ Claude agents, MCP
					servers, workflows, and tools—all curated and tested by the community.
				</Text>
				<div style={heroActionRow}>
					...
					<a
						href={buildEmailCtaUrl(`${baseUrl}/account/settings`, utm, {
			...
			<Section style={spotlightSectionStyle}>
				...
				<Text style={spotlightDescriptionStyle}>
					We'll send you weekly updates on new agents, MCP servers, and
					community highlights. You can manage your preferences anytime in your
					account settings.
				</Text>
			</Section>
			...
			<Section style={ctaStripStyle}>
				<div>
					...
					<Text style={ctaStripSubtitle}>
						Start exploring the directory and save your favorites.
					</Text>
				</div>
				<a
			...
			<EmailFooterNote
				lines={buildSubscriptionFooter("signupOAuth", { email })}
			/>
		</BaseLayout>
	);
}
