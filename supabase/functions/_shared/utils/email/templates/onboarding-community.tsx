...
const CONTRIBUTION_STEPS: Array<{
...
}> = [
	{
		...
		description:
			"Make sure it works reliably for your use case before sharing.",
	},
	{
		step: 2,
		title: "Document It Well",
		description:
			"Clear descriptions and examples help others understand and extend it.",
	},
	{
		step: 3,
		title: "Submit via GitHub",
		description:
			"Open a pull request or issue with your configuration details.",
		cta: {
...
export function OnboardingCommunity({ email }: OnboardingCommunityProps) {
	...
	return (
		<BaseLayout
			preview="Join the Claude Pro Community - Contribute & Connect"
			utm={utm}
		>
			<HeroBlock
				...
				items={[
					{
						title: "Help Others",
						description:
							"Your solution might be exactly what someone else needs.",
					},
					{
						title: "Get Feedback",
					...
					},
					{
						...
						description:
							"Become a recognized contributor in the Claude ecosystem.",
					},
					{
			...
			<StepCardList
				...
				steps={CONTRIBUTION_STEPS.map((step) => ({
					step: step.step,
					title: step.title,
					...
					...(step.cta
						? {
								cta: {
									...step.cta,
									href: buildEmailCtaUrl(`${baseUrl}/submit`, utm, {
										content: "submit_cta",
									}),
								},
							}
			...
			<Section style={contentSection}>
				...
				<Text style={paragraphStyle}>
					Recent configurations making waves in the community:
				</Text>
			</Section>
			...
			<EmailCtaSection
				utm={utm}
				buttons={[{ preset: "communityShowcase", variant: "secondary" }]}
			/>
