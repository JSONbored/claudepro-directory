...
export const UI_CLASSES = {
  ...
  ICON_ABSOLUTE_LEFT_TIGHT: 'absolute left-2 flex h-3.5 w-3.5 items-center justify-center',
  ...
  TEXT_MUTED_HOVER_PRIMARY: 'text-muted-foreground hover:text-primary transition-colors',
  ...
  CONTAINER_CENTER: 'flex flex-col items-center justify-center py-12 text-center',
