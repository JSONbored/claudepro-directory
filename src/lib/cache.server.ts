...
export const contentCache = {
  ...
  // Runtime MDX caching adds unnecessary Redis operations for static content
  // Savings: ~40K Redis commands/month
...
// REMOVED: Cache warming system (~225K Redis commands/month saved)
// Next.js ISR (Incremental Static Regeneration) already handles cache pre-population
// Redundant system that manually warmed caches for popular content
// Savings: ~225K Redis commands/month from periodic warming operations

// REMOVED: Search cache (~60K Redis commands/month saved)
// Client-side search with Fuzzysort doesn't benefit from server-side caching
// Redis round-trip adds 20-50ms latency vs instant client-side search
// Savings: ~60K Redis commands/month from search query caching
