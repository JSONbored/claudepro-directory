...
export const postCopyEmailCaptureSchema = newsletterSignupSchema.extend({
  ...
  copyCategory: z
    ...
    .max(50)
    .optional()
    .describe("Content category (agents, mcp, etc.)"),
 ...
 */
export type PostCopyEmailCaptureInput = z.input<
  typeof postCopyEmailCaptureSchema
>;

/**
 * Type inference for output (after transformation)
 */
export type PostCopyEmailCaptureData = z.output<
  typeof postCopyEmailCaptureSchema
>;
