...
/**
 * Slug validator
 * Imported from base-strings.ts (single source of truth)
 * Note: Import slugString directly from base-strings.ts in other files
 * SlugString type is exported below for type inference convenience
 */
