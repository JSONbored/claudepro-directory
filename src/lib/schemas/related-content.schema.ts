...
export const contentIndexSchema = z
  ...
  .passthrough()
  .describe(
    "Content index structure for indexing and retrieving content items",
  );
  ...
  .extend({
    categories: z
      .record(
        ...
        z
          .array(unifiedContentItemSchema)
          .describe("Array of content items in this category"),
      )
      .optional()
...
export type CategorizedContentIndex = z.infer<
  typeof categorizedContentIndexSchema
>;
...
const relatedContentItemSchema = z
  .object({
    ...
    dateAdded: z
      .string()
      .max(50)
      .describe("Date when content was added to the system"),
    tags: stringArray
      .readonly()
      .describe("Read-only array of content tags for categorization"),
    source: z
    ...
    name: z
      .string()
      .optional()
      .describe("Optional display name for the content"),
    title: z.string().optional().describe("Optional title for the content"),
    githubUsername: z
      .string()
      .optional()
      .describe("GitHub username if content is from GitHub"),
    githubUrl: z
      .string()
      .optional()
      .describe("URL to GitHub repository or profile"),
    documentationUrl: z
      .string()
      .optional()
      .describe("URL to external documentation"),
    // Related content specific fields
    score: percentage.describe(
      "Relevance score for related content matching (0-100)",
    ),
    matchType: z
    ...
    views: z
      .number()
      .optional()
      .describe("Optional view count for popularity metrics"),
    matchDetails: z
      .object({
        matchedTags: stringArray.describe(
          "Tags that matched with the source content",
        ),
        matchedKeywords: stringArray.describe(
          "Keywords that matched with the source content",
        ),
      })
      .optional()
  ...
  .describe(
    "Schema for related content items displayed in carousels and recommendation lists",
  );
...
const smartRelatedContentPropsSchema = z
  .object({
    ...
    pathname: mediumString
      .optional()
      .describe("Current page pathname for context"),
    title: z
      .string()
      .max(200)
      .optional()
    ...
    showTitle: z
      .boolean()
      .default(true)
      .describe("Whether to display the section title"),
  })
  .describe("Props schema for SmartRelatedContent component");

export type SmartRelatedContentProps = z.infer<
  typeof smartRelatedContentPropsSchema
>;
 ...
 */
const smartRelatedContentWithMetadataPropsSchema =
  smartRelatedContentPropsSchema
    .omit({ currentTags: true, currentKeywords: true })
    .extend({
      pathname: mediumString
        .optional()
        .describe("Current page pathname for context"), // Allow pathname to be passed explicitly
    })
    .describe(
      "Props schema for SmartRelatedContentWithMetadata wrapper component",
    );
...
const relatedContentPerformanceSchema = z
  .object({
    fetchTime: nonNegativeInt.describe(
      "Time taken to fetch related content in milliseconds",
    ),
    ...
    algorithmVersion: z
      .string()
      .max(50)
      .describe("Version of the matching algorithm used"),
    cacheKey: z
      .string()
      .optional()
      .describe("Optional cache key used for this request"),
    ttl: z
      .number()
      .optional()
      .describe("Optional time-to-live for cached results in seconds"),
  })
  .describe("Performance metrics for related content fetching operations");

export type RelatedContentPerformance = z.infer<
  typeof relatedContentPerformanceSchema
>;
...
const relatedCarouselClientPropsSchema = z
  .object({
    ...
    title: z
      ...
      .max(200)
      .optional()
      .describe("Optional custom title for the carousel"),
    showTitle: z
      .boolean()
      .default(true)
      .describe("Whether to display the carousel title"),
    trackingEnabled: z
      .boolean()
      .default(true)
      .describe("Whether to enable analytics tracking"),
    className: z
      .string()
      .optional()
      .describe("Optional CSS class names for styling"),
    autoPlay: z
      .boolean()
      .default(false)
      .describe("Whether carousel should auto-advance"),
    autoPlayInterval: positiveInt
      .min(1000)
      .max(10000)
      .default(5000)
      .describe(
        "Auto-play interval in milliseconds (1000-10000, default 5000)",
      ),
    showDots: z
      .boolean()
      .default(true)
      .describe("Whether to display navigation dots"),
    showArrows: z
      .boolean()
      .default(true)
      .describe("Whether to display navigation arrows"),
  })
  .describe("Props schema for client-side related content carousel component");

export type RelatedCarouselClientProps = z.infer<
  typeof relatedCarouselClientPropsSchema
>;
...
const relatedContentViewEventSchema = z
  .object({
    ...
    timestamp: isoDatetimeString.describe(
...
const relatedContentClickEventSchema = z
  .object({
    ...
    clickedItem: z
      .object({
        ...
        position: nonNegativeInt.describe(
          "Position of the item in the list (0-indexed)",
        ),
        score: z
          .number()
          .optional()
          .describe("Optional relevance score of the clicked item"),
      })
    ...
    context: z
      .object({
        ...
        algorithmVersion: z
          .string()
          .describe(
            "Version of the algorithm that generated the recommendations",
          ),
      })
      .optional()
  ...
  .describe(
    "Analytics event schema for tracking clicks on related content items",
  );
...
const relatedContentImpressionEventSchema = z
      ...
      .array(
        z
          .object({
            ...
            category: z
              .string()
              .describe("Category of the visible content item"),
            position: nonNegativeInt.describe(
              "Position of the item in the list (0-indexed)",
            ),
          })
  ...
  .describe(
    "Analytics event schema for tracking when related content items appear in viewport",
  );
...
const carouselNavigationEventSchema = z
  .object({
    ...
    timestamp: isoDatetimeString.describe(
      "ISO 8601 timestamp when the navigation occurred",
    ),
    pathname: z.string().describe("URL pathname where the navigation occurred"),
    direction: z
      .enum(["next", "previous", "dot"])
      .describe("Navigation direction or method used"),
    currentIndex: nonNegativeInt.describe(
      "Current slide index before navigation",
    ),
    targetIndex: nonNegativeInt.describe("Target slide index after navigation"),
    totalSlides: nonNegativeInt.describe(
      "Total number of slides in the carousel",
    ),
  })
  .describe(
    "Analytics event schema for tracking carousel navigation interactions",
  );
...
const relatedContentConfigSchema = z
  .object({
    enabled: z
      .boolean()
      .default(true)
      .describe("Whether related content functionality is enabled"),
    algorithm: z
    ...
    cacheConfig: z
      .object({
        enabled: z
          .boolean()
          .default(true)
          .describe("Whether caching is enabled"),
        ttl: positiveInt
          .min(60)
          .max(86400)
          .default(3600)
        ...
        maxSize: positiveInt
          ...
          .default(1000)
          .describe(
            "Maximum number of cached entries (100-10000, default 1000)",
          ),
      })
      .optional()
  ...
  .describe(
    "Configuration schema for related content system behavior and algorithm settings",
  );
...
const relatedContentRequestSchema = z
  .object({
    ...
    category: z
      .string()
      .max(50)
      .describe("Category of the source content item"),
    tags: z
      .array(z.string().max(50).describe("Tag name"))
      .optional()
    ...
    limit: positiveInt
      .max(50)
      .optional()
      .describe("Optional limit on number of results (1-50)"),
    exclude: stringArray
      .optional()
      .describe("Optional array of slugs to exclude from results"),
    includeScore: z
      .boolean()
      .optional()
  ...
  .object({
    ...
    metadata: z
      .object({
        ...
        returnedCount: nonNegativeInt.describe(
          "Number of items actually returned in response",
        ),
        algorithmUsed: z
          .string()
          .describe("Name of the algorithm used for matching"),
        processingTime: nonNegativeInt.describe(
          "Time taken to process the request in milliseconds",
        ),
        cacheStatus: z
          .enum(["hit", "miss", "bypass"])
          .describe("Cache status for this request"),
      })
