...
export const unifiedContentItemSchema = z
  .object({
    ...
    slug: z
      .string()
      .describe("Unique URL-friendly identifier for the content item"),
    description: z
      .string()
      .describe("Brief summary or overview of the content item"),
    category: z
      .enum([
        "agents",
        "mcp",
      ...
      .describe(
        "Content type category or subcategory for classification and filtering",
      ),
    author: z
      .string()
      .describe("Name or identifier of the content creator or contributor"),
    dateAdded: z
      .string()
      .optional()
    ...
    title: z
      ...
      .optional()
      .describe(
        "Display title for the content item, auto-generated for some types",
      ), // guides, auto-generated for others
    name: z
      .string()
      .optional()
      .describe("Auto-generated display name derived from slug or title"), // auto-generated display name
    content: z
      .string()
      .optional()
    ...
    lastModified: z
      .string()
      .optional()
      .describe("ISO date string when content was last updated"), // last modification date
    ...
    features: stringArray
      .optional()
      .describe("List of key features or capabilities provided"),
    useCases: stringArray
      .optional()
      .describe("Common use cases or application scenarios"),
    requirements: stringArray
      .optional()
      .describe("Prerequisites or dependencies needed for usage"),

    // URLs and documentation
    documentationUrl: optionalUrlString.describe(
      "External URL to official documentation or resources",
    ),
    githubUrl: optionalUrlString.describe(
      "GitHub repository URL for source code or project",
    ),
    ...
    installation: z
      .union([
        z.string().describe("Simple installation instructions as plain text"), // simple string format
        z
        ...
        z.union([
          ...
          z
            .object({
              ...
              solution: z
                .string()
                .describe("Step-by-step solution or workaround"),
            })
            .describe(
              "Structured troubleshooting entry with issue and solution",
            ),
        ]),
      )
      .optional()
    ...
    examples: z
      .array(
        z.union([
          z.string().describe("Simple example usage as plain text"), // MCP uses string format
          z
            .object({
              ...
              description: z
                .string()
                .describe("Explanation of what the example demonstrates"),
              prompt: z
                .string()
                .describe("Example input, prompt, or code snippet"),
              expectedOutcome: z
                .string()
                .describe("Expected result or output from the example"),
            })
            .describe(
              "Detailed example with title, description, prompt, and outcome",
            ),
        ]),
      )
      .optional()
    ...
    configLocation: z
      ...
      .optional()
      .describe(
        "File path or location where MCP configuration should be placed",
      ),
    mcpVersion: z
      .string()
      .optional()
      .describe("MCP protocol version supported by the server"),
    serverType: z
      .enum(["stdio", "http", "sse"])
      .optional()
    ...
    capabilities: z
      .object({
        resources: z
          .boolean()
          .optional()
          .describe("Whether server supports resource endpoints"),
        tools: z
          .boolean()
          .optional()
          .describe("Whether server provides tool functions"),
        prompts: z
          .boolean()
          .optional()
          .describe("Whether server offers prompt templates"),
        logging: z
          .boolean()
          .optional()
          .describe("Whether server supports logging functionality"),
      })
      .optional()
    ...
    serverInfo: z
      .object({
        ...
        version: z
          .string()
          .describe("Semantic version of the MCP server implementation"),
        protocol_version: z
          .string()
          .optional()
          .describe("MCP protocol version string"),
      })
      .optional()
      .describe(
        "Server metadata including name, version, and protocol information",
      ),

    // Rule-specific properties
    relatedRules: stringArray
      .optional()
      .describe("Slugs of related or complementary rules"),
    expertiseAreas: stringArray
      .optional()
      .describe("Domains or topics where the rule applies"),
    difficultyLevel: z
      ...
      .array(
        z
          .object({
            ...
            description: z
              .string()
              .describe("Explanation of the argument purpose and usage"),
            example: z
              .string()
              .optional()
              .describe("Example value or usage of the argument"), // Optional since some commands may not have examples for all args
          })
          .describe(
            "Command argument definition with name, description, and optional example",
          ),
      )
      .optional()
    ...
    keywords: stringArray
      .optional()
      .describe("SEO and search keywords for guide discoverability"),
    readingTime: z
      .string()
      .optional()
      .describe('Estimated time to read the guide (e.g., "5 min")'),
    difficulty: z
      .union([
        z
          .enum(["beginner", "intermediate", "advanced", "expert"])
          .describe("Standard difficulty level"),
        z.string().describe("Custom difficulty description"), // Some guides use dynamic difficulty strings
      ])
      .optional()
    ...
    featured: z
      .boolean()
      .optional()
      .describe("Whether guide should be highlighted or promoted"),
    lastReviewed: z
      .string()
      .optional()
    ...
    relatedGuides: stringArray
      .optional()
      .describe("Slugs of related or complementary guides"),
    ...
    githubUsername: z
      .string()
      .optional()
      .describe("GitHub username of the content creator"),
    stars: z
      .number()
      .optional()
      .describe("GitHub repository star count for popularity metrics"),
    popularity: z
      .number()
      .optional()
      .describe("Calculated popularity score or ranking"),
    repository: z.string().optional().describe("Repository URL or identifier"),
    documentation: z
      .string()
      .optional()
      .describe("Documentation URL or markdown content"),
  })
  .describe(
    "Unified schema for all content types with optional type-specific properties",
  );
