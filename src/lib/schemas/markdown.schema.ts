...
const mdxFrontmatterSchema = z
  .object({
    title: nonEmptyString
      .max(200)
      .describe("Content title (max 200 characters)"),
    seoTitle: z
      .string()
      .max(60)
      .optional()
    ...
    description: nonEmptyString
      .max(500)
      .describe("Content description (max 500 characters)"),
    keywords: z
    ...
    category: z
      ...
      .max(50)
      .optional()
      .describe("Content category (max 50 characters)"),
    tags: z
    ...
    aiOptimized: z
      .boolean()
      .optional()
      .describe("Whether content is optimized for AI consumption"),
    citationReady: z
      .boolean()
      .optional()
