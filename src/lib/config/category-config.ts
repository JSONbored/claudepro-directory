...
export const CATEGORY_CONFIGS: Record<string, CategoryConfig> = {
  agents: {
    ...
    icon: Sparkles,
    keywords:
      "Claude agents, AI agents, specialized assistants, workflow automation, Claude AI",
    metaDescription:
  ...
  mcp: {
    ...
    icon: Code,
    keywords:
      "MCP servers, Model Context Protocol, Claude tools, API integration",
    metaDescription:
  ...
  rules: {
    ...
    icon: BookOpen,
    keywords:
      "Claude rules, AI guidelines, project rules, behavior customization",
    metaDescription:
  ...
  statuslines: {
    ...
    icon: Terminal,
    keywords:
      "Claude statuslines, CLI customization, terminal themes, status bar",
    metaDescription:
  ...
  collections: {
    ...
    icon: Layers,
    keywords:
      "Claude collections, starter kits, workflows, bundles, curated content",
    metaDescription:
...
export type HomepageFeaturedCategory =
  (typeof HOMEPAGE_FEATURED_CATEGORIES)[number];
...
export function isValidCategory(
  category: string,
): category is keyof typeof CATEGORY_CONFIGS {
