...
function parseFrontmatterWithValidation(
  ...
  return localMdxFrontmatterSchema.parse({
    ...
    seoTitle:
      typeof rawFrontmatter.seoTitle === "string"
        ? rawFrontmatter.seoTitle
        : undefined,
    description: rawFrontmatter.description || "",
    keywords: Array.isArray(rawFrontmatter.keywords)
      ? rawFrontmatter.keywords
      : [],
    dateUpdated:
      typeof rawFrontmatter.dateUpdated === "string"
        ? rawFrontmatter.dateUpdated
        : "",
    author:
      typeof rawFrontmatter.author === "string" ? rawFrontmatter.author : "",
    category:
      typeof rawFrontmatter.category === "string"
        ? rawFrontmatter.category
        : "",
    tags: Array.isArray(rawFrontmatter.tags) ? rawFrontmatter.tags : [],
    readingTime:
      typeof rawFrontmatter.readingTime === "string"
        ? rawFrontmatter.readingTime
        : "",
    difficulty:
      typeof rawFrontmatter.difficulty === "string"
        ? rawFrontmatter.difficulty
        : "",
    aiOptimized:
      typeof rawFrontmatter.aiOptimized === "boolean"
        ? rawFrontmatter.aiOptimized
        : false,
    citationReady:
      typeof rawFrontmatter.citationReady === "boolean"
        ? rawFrontmatter.citationReady
        : false,
    schemas:
      typeof rawFrontmatter.schemas === "object" &&
      rawFrontmatter.schemas !== null
        ? {
            article:
      ...
      if (colonIndex > -1) {
        ...
        if (objectDepth === 0) {
          try {
            ...
            frontmatter[currentKey] = validated.success
              ? validated.data
              : objectContent;
          } catch (error) {
