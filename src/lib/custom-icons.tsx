 ...
 *
 * Custom SVG icon components that are NOT from lucide-react.
 * Extracted from icons.tsx to enable proper tree-shaking of lucide-react imports.
 *
 * These icons should be imported directly from this file:
 * ```ts
