...
export async function OrganizationStructuredData() {
  ...
  const organizationSchema = {
    ...
    makesOffer: [
      {
        ...
        itemOffered: {
          ...
          description:
            "Free access to community-curated Claude AI configurations and tools",
        },
        price: "0",
        priceCurrency: "USD",
      },
      {
        ...
        itemOffered: {
          ...
          description:
            "Comprehensive registry of Model Context Protocol servers",
        },
        price: "0",
        priceCurrency: "USD",
      },
    ...
    award: [
      "Community Choice - Best AI Resource 2024",
      "Top Developer Tool Directory 2024",
    ],
  ...
  const serviceSchema = {
    ...
    description:
      "Free, community-driven directory of Claude AI configurations and tools",
    provider: {
      "@id": `${baseUrl}/#organization`,
    },
