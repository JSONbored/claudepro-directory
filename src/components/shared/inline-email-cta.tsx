...
function getContextualMessage(category?: string): {
  ...
  const messages = {
    ...
    commands: {
      ...
      description:
        "Get new Claude commands and productivity tips in your inbox.",
    },
    rules: {
      headline: "Master Claude Customization",
      description:
        "Weekly updates on rules, configurations, and best practices.",
    },
    hooks: {
    ...
    default: {
      ...
      description:
        "Get weekly updates on new tools, guides, and community highlights.",
    },
  ...
  if (variant === "hero") {
    return (
      ...
      >
        ...
        <h2
          className={`text-3xl md:text-4xl ${UI_CLASSES.FONT_BOLD} ${UI_CLASSES.MB_4}`}
        >
          {finalHeadline}
        </h2>
        <p
          className={`text-lg text-muted-foreground ${UI_CLASSES.MB_6} max-w-2xl mx-auto`}
        >
          {finalDescription}
        </p>
      ...
      <Card className={cn("border-primary/20 bg-card/50", className)}>
        ...
        <CardContent>
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            Join our community of Claude power users. No spam, unsubscribe
            anytime.
          </p>
        </CardContent>
      </Card>
