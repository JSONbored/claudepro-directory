...
const TabsTrigger = ({
  ...
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'relative inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 font-medium text-sm ring-offset-background transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-foreground [&[data-state=active]>.tab-indicator]:block',
      className
    )}
    {...props}
  >
    ...
    <motion.span
      ...
      className="tab-indicator -z-10 absolute inset-0 hidden rounded-sm bg-background shadow-sm"
      transition={{
        type: 'spring',
        stiffness: 500,
        damping: 30,
...
const TabsContent = ({
  ...
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      'data-[state=active]:fade-in-0 data-[state=active]:slide-in-from-bottom-2 mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 data-[state=active]:animate-in',
      className
    )}
    {...props}
  />
