  ...
  return (
    <AnimatePresence mode="wait">
      <motion.button
        ...
        className={`${POSITION_PATTERNS.FIXED_BOTTOM_RIGHT_LG} relative z-30 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-black/20 shadow-lg ${ANIMATION_CONSTANTS.CSS_TRANSITION_DEFAULT} will-change-transform hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-background md:hidden dark:shadow-black/40`}
