 ...
 *
 * Solution: Use type-fest MergeDeep to override generated types with correct nullability.
 *
 * Also includes temporary RPC function types that haven't been picked up by supabase gen types yet.
 *
 * @see https://github.com/sindresorhus/type-fest#mergedeep
 */
...
/**
 * Override view nullability
 */
type DatabaseWithViewOverrides = MergeDeep<
  DatabaseGenerated,
  {
    public: {
      Views: {
