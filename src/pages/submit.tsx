...
const Submit = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description:
        "Thank you for your contribution. We'll review it and add it to the directory soon.",
    });
    // Reset form
    setFormData({
      title: '',
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                  <CardHeader className="text-center">
                    ...
                    <CardDescription>
                      System prompts, instructions, and configurations that enhance Claude's
                ...
                >
                  <CardHeader className="text-center">
                    ...
                    <CardDescription>
                      Model Context Protocol servers that extend Claude with external tools and
                      integrations.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                >
                  <CardHeader className="text-center">
                    ...
                    <CardDescription>
                      Specialized AI agents with defined roles, capabilities, and workflows for
                      specific domains.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        configType === 'rule'
                          ...
                          : configType === 'mcp'
                            ...
                            : configType === 'agent'
                              ...
                              : configType === 'command'
                                ? 'Describe what this command does and its use cases...'
                                : configType === 'hook'
                                  ? 'Describe what events trigger this hook and what it does...'
                      ...
                      placeholder={
                        configType === 'rule'
                          ...
                          : configType === 'mcp'
                            ...
                            : configType === 'agent'
                              ? 'Provide detailed instructions and capabilities for the agent...'
                              : configType === 'command'
                                ? 'Describe the command syntax, parameters, and implementation...'
                                : configType === 'hook'
                                  ? 'Define trigger events, actions, and configuration options...'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-muted-foreground">
                        Create an issue with your configuration
                      </div>
                    </div>
                  </Button>
