import { Calendar, Github, Globe, Star, User } from 'lucide-react';
...
const Author = () => {
  ...
  const authorData = {
    ...
    github:
      authorSlug === 'claude-mcp-community' ? 'https://github.com/modelcontextprotocol' : undefined,
    joinDate: '2024-01-15',
        ...
        {authorRules.length > 0 && (
          <div>
            <h2 className="text-2xl font-bold text-foreground mb-6">
              Claude Rules ({authorRules.length})
            </h2>
