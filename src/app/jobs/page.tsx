...
function filterJobs(jobs: Job[], params: JobsSearchParams): Job[] {
  return jobs.filter((job) => {
    ...
    const searchQuery =
      params.q || params.query || params.search || params.location;
    const matchesSearch =
      !searchQuery ||
  ...
  return (
    <div className={`${UI_CLASSES.MIN_H_SCREEN} bg-background`}>
      ...
      <section className={UI_CLASSES.CONTAINER_OVERFLOW_BORDER}>
        <div
          className={`container ${UI_CLASSES.MX_AUTO} ${UI_CLASSES.PX_4} py-20`}
        >
          <div
            className={`text-center ${UI_CLASSES.MAX_W_3XL} ${UI_CLASSES.MX_AUTO}`}
          >
            <div
              className={`flex ${UI_CLASSES.JUSTIFY_CENTER} ${UI_CLASSES.MB_6}`}
            >
              <div
            ...
            <p className={UI_CLASSES.TEXT_HEADING_MEDIUM}>
              Discover opportunities with companies building the future of
              artificial intelligence. From startups to industry giants, find
              your perfect role.
            </p>

            <div
              className={`flex flex-wrap ${UI_CLASSES.JUSTIFY_CENTER} gap-2 ${UI_CLASSES.MB_8}`}
            >
            ...
            <Card className="card-gradient glow-effect">
              <CardContent className="p-6">
                <form
                  method="GET"
                  action="/jobs"
                  className={UI_CLASSES.GRID_RESPONSIVE_4}
                >
                  ...
                  <Select
                    name="employment"
                    defaultValue={params.employment || "any"}
                  >
                    <SelectTrigger
                ...
                {(params.search ||
                  ...
                  >
                    <span className={UI_CLASSES.TEXT_SM_MUTED}>
                      Active filters:
                    </span>
                    {(params.search || params.q || params.query) && (
                      <Badge variant="secondary">
        ...
        <div className={UI_CLASSES.SPACE_Y_8}>
          {jobs.length === 0 ? (
            ...
            <Card>
              ...
              >
                <div
                  className={`p-4 bg-accent/10 rounded-full ${UI_CLASSES.MB_6}`}
                >
                  <Briefcase
                    className={`h-12 w-12 ${UI_CLASSES.TEXT_MUTED_FOREGROUND}`}
                  />
                </div>
                ...
                >
                  We're building our jobs board! Soon you'll find amazing
                  opportunities with companies working on the future of AI. Be
                  the first to know when new positions are posted.
                </p>
            ...
            <Card>
              ...
              >
                <Briefcase
                  className={`h-16 w-16 ${UI_CLASSES.TEXT_MUTED_FOREGROUND} mb-4`}
                />
                <h3
                  className={`${UI_CLASSES.TEXT_XL} font-semibold ${UI_CLASSES.MB_2}`}
                >
                  No Jobs Found
                </h3>
                <p
