...
export default function CommunityPage() {
  return (
    <div className={`${UI_CLASSES.MIN_H_SCREEN} bg-background`}>
      {/* Hero Section */}
      <section
        className={`relative py-24 ${UI_CLASSES.PX_4} ${UI_CLASSES.OVERFLOW_HIDDEN}`}
      >
        <div className={`container ${UI_CLASSES.MX_AUTO} text-center`}>
          <div className={`${UI_CLASSES.MAX_W_3XL} ${UI_CLASSES.MX_AUTO}`}>
            ...
            <h1
              className={`text-4xl md:text-6xl ${UI_CLASSES.FONT_BOLD} ${UI_CLASSES.MB_6}`}
            >
              Join the Claude Community
            </h1>

            <p className={UI_CLASSES.TEXT_HEADING_LARGE}>
              Connect with developers and AI enthusiasts building with Claude.
              Share your configurations, learn from the community, and
              contribute to our open-source directory.
            </p>

            <div
              className={`${UI_CLASSES.FLEX_WRAP_GAP_4} ${UI_CLASSES.JUSTIFY_CENTER}`}
            >
              ...
              <Button size="lg" variant="outline" asChild>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <Twitter className={`h-5 w-5 ${UI_CLASSES.MR_2}`} />X
                  (Twitter)
                </a>
              </Button>
            </div>
        ...
        <div className={`container ${UI_CLASSES.MX_AUTO}`}>
          <div className={UI_CLASSES.GRID_RESPONSIVE_3}>
            ...
            <Card>
              ...
              <CardContent>
                <div className={`text-3xl ${UI_CLASSES.FONT_BOLD}`}>
                  Growing
                </div>
                <p className={UI_CLASSES.TEXT_MUTED_FOREGROUND}>
                  Join us on GitHub
        ...
        <div className={`container ${UI_CLASSES.MX_AUTO}`}>
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3
                  className={`${UI_CLASSES.FONT_SEMIBOLD} ${UI_CLASSES.MB_2}`}
                >
                  1. Fork the Repository
                </h3>
                <p className={UI_CLASSES.TEXT_MUTED_FOREGROUND}>
                  Start by forking our GitHub repository and cloning it to your
                  local machine.
                </p>
              </div>
              <div>
                ...
                <p className={UI_CLASSES.TEXT_MUTED_FOREGROUND}>
                  Create a new JSON file with your Claude configuration in the
                  appropriate content directory.
                </p>
              </div>
              <div>
                <h3
                ...
                <p className={UI_CLASSES.TEXT_MUTED_FOREGROUND}>
                  Submit a pull request with your contribution. Our team will
                  review it promptly.
                </p>
              </div>
              <div className="pt-4">
