    ...
    <div className={`${UI_CLASSES.MIN_H_SCREEN} bg-background`}>
      ...
      <section className={`relative py-16 px-4 ${UI_CLASSES.OVERFLOW_HIDDEN}`}>
        <div className={`container ${UI_CLASSES.MX_AUTO} text-center ${UI_CLASSES.MAX_W_4XL}`}>
          ...
          {/* Description */}
          <p className={`text-lg md:text-xl ${UI_CLASSES.TEXT_MUTED_FOREGROUND} ${UI_CLASSES.MAX_W_3XL} ${UI_CLASSES.MX_AUTO} mb-8`}>
            Answer 7 quick questions and get personalized recommendations from our catalog of 147+ configurations.
            Instant results, zero cost, tailored to your needs.
          </p>
        ...
        <div className={`${UI_CLASSES.MAX_W_4XL} ${UI_CLASSES.MX_AUTO}`}>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Tell us about your use case, experience level, and preferences in 7 quick questions.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Our algorithm analyzes 147+ configurations and matches them to your specific needs.
                </CardDescription>
              </CardContent>
            </Card>
