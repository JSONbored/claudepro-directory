  ...
  try {
    ...
    const categoryStats = [
      ...
      },
      {
        ...
        url: "/commands",
        description:
          "Custom slash commands for Claude Code to streamline development workflows",
      },
      {
        name: "Hooks",
      ...
      },
      {
        ...
        url: "/agents",
        description:
          "Specialized AI agents with predefined roles and expertise areas",
      },
      {
        name: "Statuslines",
      ...
      },
      {
        ...
        url: "/collections",
        description:
          "Curated bundles of related configurations for specific use cases",
      },
    ];
