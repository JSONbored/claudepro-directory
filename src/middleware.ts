...
export const config = {
  matcher: [
     ...
     */
    '/((?!_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|manifest|service-worker.js|offline.html|\\.well-known|assets/|scripts/|863ad0a5c1124f59a060aa77f0861518\\.txt|.*\\.(?:png|jpg|jpeg|gif|webp|svg|ico)$).*)',
  ],
};
