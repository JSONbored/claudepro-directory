...
// Version: 1.0.0
// Generated by scripts/generate-service-worker.ts
// DO NOT EDIT MANUALLY - Changes will be overwritten at build time
//
// Configuration sources:
// - Categories: src/lib/config/category-config.ts (UNIFIED_CATEGORY_REGISTRY)
// - Origins: src/lib/constants/security.ts (SECURITY_CONFIG.allowedOrigins)
...
// Security constants (auto-synced with src/lib/constants/security.ts SECURITY_CONFIG)
const TRUSTED_HOSTNAMES = {
  umami: "umami.claudepro.directory",
  vercel: "va.vercel-scripts.com",
};

// Allowed origins (auto-synced with SECURITY_CONFIG.allowedOrigins)
...
const STATIC_CACHE = "claudepro-static-v1.0.0";
const DYNAMIC_CACHE = "claudepro-dynamic-v1.0.0";
const API_CACHE = "claudepro-api-v1.0.0";
