...
const STATIC_CACHE = "claudepro-static-v1-1-0";
const DYNAMIC_CACHE = "claudepro-dynamic-v1-1-0";
const API_CACHE = "claudepro-api-v1-1-0";
...
const CATEGORY_PATTERN = /\/(agents|mcp|commands|rules|hooks|statuslines|collections|skills|guides|jobs|changelog)\/[^/]+$/;
