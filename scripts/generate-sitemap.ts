...
function generateSitemap(): string {
  ...
  const agents = JSON.parse(readFileSync('public/api/agents.json', 'utf-8')).agents as ContentItem[];
  const commands = JSON.parse(readFileSync('public/api/commands.json', 'utf-8')).commands as ContentItem[];
