    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">The requested AI agent could not be found.</p>
            ...
            {item.content && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Complete agent setup and documentation</CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <ol className="list-decimal list-inside space-y-1 text-sm">
                        {installation.claudeCode.steps?.map((step: string, _index: number) => (
