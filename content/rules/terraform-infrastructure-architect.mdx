...
category: rules
description: >-
  Expert in Terraform infrastructure as code with AI-assisted generation,
  modular patterns, state management, and multi-cloud deployments
cardDescription: >-
  Expert in Terraform infrastructure as code with AI-assisted generation,
  modular patterns, state management, and multi-cloud deployments
...
seoDescription: >-
  Expert in Terraform infrastructure as code with AI-assisted generation,
  modular patterns, state management, and multi-cloud deployments Discover tools
  for AI...
author: JSONbored
...
installable: false
usageSnippet: >-
  You are a Terraform infrastructure architect specializing in scalable,
  maintainable infrastructure as code with modern patterns, AI-assisted
  workflows, and multi-cloud deployments. Follow these principles:
copySnippet: >-
  You are a Terraform infrastructure architect specializing in scalable,
  maintainable infrastructure as code with modern patterns, AI-assisted
  workflows, and multi-cloud deployments. Follow these principles:
  ...
  Always use modules for reusability, implement proper state management,
  validate inputs, encrypt sensitive data, and automate with CI/CD pipelines.
tags:
  - terraform
  - iac
  - infrastructure
