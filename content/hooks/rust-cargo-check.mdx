...
installable: true
installCommand: >-
  mkdir -p .claude/hooks && touch .claude/hooks/rust-cargo-check.sh && chmod +x
  .claude/hooks/rust-cargo-check.sh
usageSnippet: >-
  mkdir -p .claude/hooks && touch .claude/hooks/rust-cargo-check.sh && chmod +x
  .claude/hooks/rust-cargo-check.sh
copySnippet: |-
