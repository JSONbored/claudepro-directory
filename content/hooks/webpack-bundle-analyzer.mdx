...
installable: true
installCommand: >-
  mkdir -p .claude/hooks && touch .claude/hooks/webpack-bundle-analyzer.sh &&
  chmod +x .claude/hooks/webpack-bundle-analyzer.sh
usageSnippet: >-
  mkdir -p .claude/hooks && touch .claude/hooks/webpack-bundle-analyzer.sh &&
  chmod +x .claude/hooks/webpack-bundle-analyzer.sh
copySnippet: |-
...
2. Create hook file: touch .claude/hooks/webpack-bundle-analyzer.sh
3. Make executable: chmod +x .claude/hooks/webpack-bundle-analyzer.sh
...
```json
{
  "webpack_bundle_analyzer": {
    ...
    "file_patterns": ["*webpack.config.*", "*vite.config.*", "*rollup.config.*", "package.json", "src/index.*", "src/main.*"],
