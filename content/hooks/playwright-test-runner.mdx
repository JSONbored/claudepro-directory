...
installCommand: >-
  ...
  chmod +x .claude/hooks/playwright-test-runner.sh
usageSnippet: >-
  mkdir -p .claude/hooks && touch .claude/hooks/playwright-test-runner.sh &&
  chmod +x .claude/hooks/playwright-test-runner.sh
copySnippet: |-
