---
title: HeyClaude MCP Server - Access HeyClaude via MCP
slug: heyclaude-mcp
category: mcp
description: >-
  Access the complete HeyClaude directory through HeyClaude's official MCP
  server. Search prompts, agents, MCP servers, rules, commands, and more
  directly from Claude Desktop, Cursor, or any MCP client.
cardDescription: >-
  Access the complete HeyClaude directory through HeyClaude's official MCP
  server.
seoTitle: HeyClaude MCP Server - Access HeyClaude via MCP
seoDescription: >-
  Access the complete HeyClaude directory through HeyClaude's official MCP
  server. Search prompts, agents, MCP servers, rules, commands, and more
  directly fro...
...
downloadUrl: /downloads/mcp/heyclaude-mcp.mcpb
