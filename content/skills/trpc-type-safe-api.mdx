...
category: skills
description: >-
  Build end-to-end type-safe APIs with tRPC and TypeScript, eliminating code
  generation and runtime bloat for full-stack applications. tRPC provides
  end-to-end type safety without code generation, schema stitching, or
  serialization layers - delivering a lighter, more intuitive developer
  experience than REST or GraphQL. With zero dependencies, tiny client-side
  footprint, and automatic type inference, tRPC makes full-stack TypeScript
  development actually enjoyable. Features include automatic React Query hooks
  generation, WebSocket subscriptions support, middleware for authentication and
  authorization, input validation with Zod, error handling with TRPCError,
  batching for performance optimization, and adapters for Express, Next.js,
  Fastify, and standalone servers.
cardDescription: >-
  Build end-to-end type-safe APIs with tRPC and TypeScript, eliminating code
  generation and runtime bloat for full-stack applications.
...
prerequisites:
  ...
  - >-
    TypeScript 5.0+ for full type inference and end-to-end type safety between
    client and server
tags:
  - trpc
  - typescript
