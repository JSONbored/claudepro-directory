...
category: skills
description: >-
  Aggregate Markdown folders into cohesive knowledge bases with automated table
  of contents generation, cross-link validation and rewriting, heading
  normalization, and multi-format export (HTML, PDF, DOCX, EPUB). Supports
  GitHub Flavored Markdown (GFM), frontmatter parsing (YAML/TOML), code syntax
  highlighting, image processing, static site generation, and link management
  across distributed documentation. Includes tools for documentation
  consolidation, README generation, and knowledge base publishing with search
  functionality.
cardDescription: >-
  Aggregate Markdown folders into cohesive knowledge bases with automated table
  of contents generation, cross-link validation and rewriting...
...
prerequisites:
  ...
  - >-
    File system read/write access for Markdown source files, generated
    HTML/PDF/DOCX/EPUB outputs, and image assets referenced in Markdown
  - >-
    Markdown syntax knowledge or reference documentation for creating valid
    Markdown files (CommonMark or GitHub Flavored Markdown specification)
tags:
  - markdown
  - docs
  - remark
