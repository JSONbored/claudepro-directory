...
cardDescription: "Create validated HeyClaude submission drafts with category fit, brand metadata, source URLs, SEO fields, and issue-first review notes."
seoTitle: HeyClaude Content Submission Factory Skill
seoDescription: "Reusable skill for preparing high-quality HeyClaude registry submissions with category fields, brand metadata, sources, SEO, and review-ready issue content."
author: JSONbored
...
copySnippet: |-
  ...
  3) Source and brand metadata
  4) SEO and citation notes
  5) GitHub issue-first submission URL
skillType: workflow
skillLevel: advanced
...
retrievalSources:
  ...
  - "https://github.com/JSONbored/claudepro-directory/issues/new/choose"
testedPlatforms:
  - Claude
  - Codex
  - Windsurf
...
4. Add brand metadata when safe: `brandName`, `brandDomain`, and official source links.
5. Write a concise original description and card description.
6. Draft SEO metadata from the resource title, category, tags, and source-backed value.
7. Produce issue-first submission fields and a prefilled HeyClaude or GitHub submission URL.
...
- Do not create PRs, write files, or mutate local project config.
