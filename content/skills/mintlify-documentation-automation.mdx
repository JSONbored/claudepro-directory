...
category: skills
description: >-
  Automate beautiful, searchable documentation creation with Mintlify - the
  modern AI-native documentation platform. Generate comprehensive API reference
  documentation from TypeScript/JSDoc code, convert OpenAPI specifications to
  interactive API playgrounds, create interactive MDX components (Tabs,
  Accordion, CodeGroup, Steps, Cards), and build multi-version documentation
  sites. Includes built-in search, analytics integration, dark mode support, and
  automated deployment workflows. Supports component library documentation, SDK
  documentation, and product documentation with guides and tutorials.
cardDescription: >-
  Automate beautiful, searchable documentation creation with Mintlify - the
  modern AI-native documentation platform.
...
prerequisites:
  ...
  - >-
    Mintlify account and API access (free tier available) for documentation site
    hosting and deployment
  - >-
    File system read/write access for Mintlify configuration files (mint.json),
    documentation source files, and generated documentation outputs
tags:
  - mintlify
  - documentation
  - mdx
