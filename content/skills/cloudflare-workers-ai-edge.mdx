...
category: skills
description: >-
  Deploy AI models and serverless functions to Cloudflare's global edge network
  with sub-5ms cold starts and 40% edge computing market share. Access 50+
  open-source AI models (Llama-2, Whisper, Stable Diffusion) with pay-per-use
  pricing. Includes 10,000 free Neurons per day, integrated D1/R2/KV storage,
  and deployment to 275+ cities worldwide.
cardDescription: >-
  Deploy AI models and serverless functions to Cloudflare's global edge network
  with sub-5ms cold starts and 40% edge computing market share.
...
prerequisites:
  ...
  - >-
    Cloudflare account with Workers AI enabled (available on Free and Paid
    plans)
  - >-
    Wrangler CLI authentication configured (wrangler login) for deployment
    access
tags:
  - cloudflare
  - edge-computing
