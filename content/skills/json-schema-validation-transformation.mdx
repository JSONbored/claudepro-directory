...
category: skills
description: >-
  Validate JSON data against JSON Schema specifications (draft-07, 2019-09,
  2020-12) and perform safe, lossless schema migrations and transformations
  using Ajv (fastest JSON Schema validator) and Zod (TypeScript-first
  validation). Supports schema-aware data migration, TypeScript type generation,
  format validation, custom keywords, conditional schemas, and batch processing.
  Includes comprehensive error reporting with JSON path references, schema
  compilation optimization, and transformation pipelines for API payloads,
  configuration files, and data normalization.
cardDescription: >-
  Validate JSON data against JSON Schema specifications (draft-07, 2019-09,
  2020-12) and perform safe, lossless schema migrations and trans...
...
prerequisites:
  ...
  - >-
    File system read/write access for JSON schema files, data files, and
    generated TypeScript type definitions
  - >-
    JSON Schema specification knowledge or reference documentation for creating
    valid schemas (draft-07, 2019-09, or 2020-12)
tags:
  - json
  - schema
  - validation
