...
installable: true
usageSnippet: '✓ Health: B (82/100) | GOOD | C:25 L:18 P:22 K:17'
copySnippet: |-
  {
    "statusLine": {
      "type": "command",
...
prerequisites:
  ...
  - >-
    ...
    // defaults)
  - >-
    bc calculator (required for floating point calculations: cost per minute,
    latency seconds, lines per minute)
  - >-
  ...
  - >-
    ...
    cache_creation_input_tokens fields in cost object)
tags:
  - health-score
  - session-grade
