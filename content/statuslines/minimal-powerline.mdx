...
scriptBody: >-
  ...
  echo -e "${MODEL_BG} ${model} ${RESET}${MODEL_FG}${SEP}${RESET} ${DIR_BG}
  ${dir} ${RESET}${DIR_FG}${SEP}${RESET} ${TOKEN_BG} ${tokens}
  ${RESET}${TOKEN_FG}${SEP}${RESET}"
prerequisites:
  ...
  - >-
    ...
    // defaults)
  - >-
    Terminal with 256-color support (xterm-256color or screen-256color
    recommended for proper color display)
  - >-
    Powerline-patched font or Nerd Font installed (required for Powerline
    separator glyphs U+E0B0-U+E0B3 to display correctly)
  - >-
    Terminal font configured to use Powerline/Nerd Font (font must be set in
