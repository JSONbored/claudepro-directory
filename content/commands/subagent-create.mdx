...
category: commands
description: >-
  Create specialized Claude Code subagents with custom system prompts, scoped
  tool access, and independent context for parallel task execution and workflow
  orchestration
cardDescription: >-
  Create specialized Claude Code subagents with custom system prompts, scoped
  tool access, and independent context for parallel task execut...
...
usageSnippet: '/subagent-create [role] [options]'
copySnippet: '/subagent-create [role] [options]'
tags:
  - subagents
  - orchestration
  - parallel-execution
...
robotsIndex: true
robotsFollow: true
commandSyntax: '/subagent-create [role] [options]'
---
