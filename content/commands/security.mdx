...
category: commands
description: >-
  Comprehensive security audit with vulnerability detection, threat analysis,
...
seoDescription: >-
  Comprehensive security audit with vulnerability detection, threat analysis,
  and automated remediation recommendations Discover tools for AI development.
author: JSONbored
...
robotsIndex: true
robotsFollow: true
commandSyntax: '/security [options] <file_or_project>'
---
