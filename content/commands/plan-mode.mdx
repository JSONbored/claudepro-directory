...
category: commands
description: >-
  Activate Claude's extended thinking mode with multi-level planning depth from
  'think' to 'ultrathink' for comprehensive strategy creation before
  implementation
cardDescription: >-
  Activate Claude's extended thinking mode with multi-level planning depth from
  'think' to 'ultrathink' for comprehensive strategy creation...
...
robotsIndex: true
robotsFollow: true
commandSyntax: '/plan-mode [task] [depth]'
---
