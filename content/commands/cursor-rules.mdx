...
category: commands
description: >-
  Generate .cursorrules files for AI-native development with project-specific
  patterns, coding standards, and intelligent context awareness
cardDescription: >-
  Generate .cursorrules files for AI-native development with project-specific
  patterns, coding standards, and intelligent context awareness
...
seoDescription: >-
  Generate .cursorrules files for AI-native development with project-specific
  patterns, coding standards, and intelligent context awareness Discover tools
  for ...
author: JSONbored
...
usageSnippet: '/cursor-rules [options] <project_type>'
copySnippet: '/cursor-rules [options] <project_type>'
scriptLanguage: text
scriptBody: >-
  The `/cursor-rules` command generates comprehensive `.cursorrules` files
  tailored to your project's technology stack, coding standards, and
  architectural patterns for optimal AI-assisted development.
  ...
  **Command:**
  ...
  /cursor-rules --nextjs --typescript --tailwind --prisma --trpc --strict
  ...
  **Generated `.cursorrules`:**
  ...
  You are an expert full-stack developer specializing in Next.js 15, React 19,
  TypeScript, TailwindCSS v4, Prisma, and tRPC.
  ...
  **Generated `.cursorrules`:**
  ...
  You are an expert Python backend developer specializing in FastAPI, async
  programming, and RESTful API design.
...
robotsIndex: true
robotsFollow: true
commandSyntax: '/cursor-rules [options] <project_type>'
---
