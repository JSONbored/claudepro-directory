...
category: commands
description: >-
  Generate beautiful, searchable documentation using Mintlify with AI-powered
  content generation, API reference automation, and MDX components
cardDescription: >-
  Generate beautiful, searchable documentation using Mintlify with AI-powered
  content generation, API reference automation, and MDX components
...
seoDescription: >-
  Generate beautiful, searchable documentation using Mintlify with AI-powered
  content generation, API reference automation, and MDX components Discover
  tools f...
author: JSONbored
...
usageSnippet: '/mintlify-docs [options] <documentation_scope>'
copySnippet: '/mintlify-docs [options] <documentation_scope>'
scriptLanguage: text
scriptBody: >-
  The `/mintlify-docs` command generates comprehensive, production-ready
  documentation using Mintlify with AI-powered content creation, API reference
  automation, and interactive MDX components.
  ...
  **Generated Documentation:**
  ...
  The User API provides endpoints for managing user accounts, authentication,
  and profiles.
  ...
  **Command:**
  ...
  /mintlify-docs --quickstart --from-code=src/ "Getting started with our
  ...
  **Generated Documentation:**
  ...
  This guide will help you integrate authentication into your application in
  under 5 minutes.
...
robotsIndex: true
robotsFollow: true
commandSyntax: '/mintlify-docs [options] <documentation_scope>'
---
