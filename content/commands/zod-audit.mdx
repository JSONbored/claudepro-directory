...
category: commands
description: >-
  Production codebase auditor specialized in Zod schema validation coverage,
  security vulnerability detection, and dead code elimination
cardDescription: 'Audit a codebase for Zod coverage, security gaps, dead code, and duplication.'
seoTitle: /zod-audit - Zod Auditor Command for Claude Code
seoDescription: >-
  Production codebase auditor specialized in Zod schema validation coverage,
  security vulnerability detection, and dead code elimination Discover tools for
  AI ...
author: JSONbored
...
copyCount: 0
popularityScore: 34
commandSyntax: '/zod-audit [audit-type=full|security|duplication|validation|zod] [path]'
allowedTools:
  - 'Bash(find:*)'
  - 'Bash(grep:*)'
  - 'Bash(rg:*)'
