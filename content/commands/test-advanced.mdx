...
category: commands
description: >-
  Advanced test suite generator with property-based testing, mutation testing,
  and intelligent test case discovery
cardDescription: >-
  Advanced test suite generator with property-based testing, mutation testing,
  and intelligent test case discovery
...
seoDescription: >-
  Advanced test suite generator with property-based testing, mutation testing,
  and intelligent test case discovery Discover tools for AI development.
author: JSONbored
...
copySnippet: '/test [options] <file_or_function>'
tags:
  - testing
  - unit-tests
  - integration-tests
...
robotsIndex: true
robotsFollow: true
commandSyntax: '/test [options] <file_or_function>'
---
