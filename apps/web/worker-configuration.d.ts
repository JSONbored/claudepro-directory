/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv worker-configuration.d.ts` (hash: b8ce6d3d3c436570204f46b8ded05dda)
// Runtime types generated with workerd@1.20260409.1 2026-04-05 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface DevEnv {
		...
		WORKER_SELF_REFERENCE: Fetcher /* heyclaude-dev */;
	}
	interface Env {
		SITE_DB: D1Database;
		VOTES_DB: D1Database;
		...
		NEXT_PUBLIC_POLAR_FEATURED_JOB_URL: "/jobs/post?tier=featured";
		NEXT_PUBLIC_POLAR_JOB_BOARD_URL: "/jobs/post?tier=standard";
		WORKER_SELF_REFERENCE: Fetcher /* heyclaude-dev */ | Fetcher /* heyclaude-prod */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_DISCORD_URL" | "NEXT_PUBLIC_TWITTER_URL" | "NEXT_PUBLIC_POLAR_SPONSORED_JOB_URL" | "NEXT_PUBLIC_POLAR_FEATURED_JOB_URL" | "NEXT_PUBLIC_POLAR_JOB_BOARD_URL">> {}
}
