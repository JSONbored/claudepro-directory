...
import type { SearchResult } from '@heyclaude/web-runtime';
import type { LucideIcon } from '@heyclaude/web-runtime/icons';
import type {
  CategoryStatsConfig as SharedCategoryStatsConfig,
  SectionId as SharedSectionId,
  TabConfig as SharedTabConfig,
  UnifiedCategoryConfig as SharedUnifiedCategoryConfig,
} from '@heyclaude/web-runtime/types/category';
...
/**
 * Section identifier for content detail pages (re-exported from shared runtime)
 */
export type SectionId = SharedSectionId;

/**
 * Tab configuration for detail pages (re-exported from shared runtime)
 */
export type TabConfig = SharedTabConfig;

export type UnifiedCategoryConfig<TId extends string = string> = SharedUnifiedCategoryConfig<TId>;

export type CategoryStatsConfig = SharedCategoryStatsConfig;
