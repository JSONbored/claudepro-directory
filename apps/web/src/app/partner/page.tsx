  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mx-auto mb-12 max-w-5xl text-center">
        <h1 className="mb-4 text-2xl font-bold sm:text-2xl md:text-3xl lg:text-4xl">
        ...
        <div className="mx-auto mb-8 grid max-w-3xl grid-cols-3 gap-4">
          <Card>
            <CardContent className="pt-6 pb-6">
              <p className="text-primary mb-1 text-2xl font-semibold">
          ...
          <HoverCard variant="strong">
            <Card className="relative overflow-hidden border-2">
              ...
              <CardContent className="space-y-4">
                {/* Pricing */}
                <div className="bg-muted/30 border-border card-base p-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-2">
                    <Check className="mt-0.5 h-4 w-4 text-green-500 dark:text-green-400" />
            ...
            <Card className="relative overflow-hidden border-2">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-muted/30 border-border card-base p-4">
                  ...
                  <p className="text-muted-foreground text-xs">Per listing • Launch pricing</p>
                </div>
      ...
      <div className="mx-auto mb-16 max-w-4xl">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card>
            <CardContent className="pt-6">
              <MousePointer className="text-primary mb-4 h-8 w-8" />
