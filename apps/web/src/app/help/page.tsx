          ...
          {commonQuestions.map((item) => (
            <Card key={item.question}>
              ...
              <CardContent>
                ...
                {item.link ? (
                  <NavLink className="inline-flex items-center gap-0.5" href={item.link.href}>
                    {item.link.label} →
                  </NavLink>
                ) : null}
              </CardContent>
        ...
        <CardContent className="pt-6">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-3">
              <NavLink
                className="bg-accent text-accent-foreground hover:bg-accent/90 inline-flex items-center gap-2 rounded-lg px-4 py-2 transition-colors"
                href="/contact"
              >
              ...
              <Link
                className="border-accent/20 hover:bg-accent/10 card-base inline-flex items-center gap-2 px-4 py-2 transition-colors"
                href="/community"
              >
                Join Community
              </Link>
