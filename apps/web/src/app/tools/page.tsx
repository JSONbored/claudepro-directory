  ...
  const jsonLd = [
    ...
    buildItemListJsonLd(
      ...
      })),
      {
        ...
        description: "Apps, tools, services, and products for Claude-native builders.",
      },
    ),
  ];
  ...
  return (
    <div className="container-shell space-y-8 py-12">
      ...
      <div className="space-y-4 border-b border-border/80 pb-8">
        ...
        <h1 className="section-title">Tools, apps, and services for Claude builders.</h1>
        <p className="max-w-3xl text-sm leading-8 text-muted-foreground">
          A separate commercial/editorial directory for products that help people build with Claude. Organic listings are free and reviewed; paid placements are optional and clearly disclosed.
        </p>
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/submit" className="inline-flex items-center rounded-full border border-border bg-card px-4 py-2 text-sm text-foreground transition hover:border-primary/40">
