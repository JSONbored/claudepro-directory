  ...
  return (
    <div className={`container ${marginX.auto} max-w-4xl ${paddingX.default} ${paddingY.relaxed} sm:${paddingY.section}`}>
      <div className="prose prose-invert max-w-none">
        <h1 className={`${marginBottom.comfortable} text-3xl font-bold sm:text-4xl`}>Cookie Policy</h1>
        <p className={`text-muted-foreground ${marginBottom.relaxed}`}>Last updated: {lastUpdated}</p>

        <section className={`${marginBottom.relaxed}`}>
          <h2 className={`${marginBottom.default} text-2xl font-semibold`}>1. What Are Cookies</h2>
        ...
        <section className={`${marginBottom.relaxed}`}>
          <h2 className={`${marginBottom.default} text-2xl font-semibold`}>2. How We Use Cookies</h2>
        ...
        <section className={`${marginBottom.relaxed}`}>
          <h2 className={`${marginBottom.default} text-2xl font-semibold`}>3. Types of Cookies We Use</h2>

          <div className={`${marginBottom.comfortable}`}>
            <h3 className={`${marginBottom.compact} text-xl font-semibold`}>Essential Cookies</h3>
            <p className={`${marginBottom.compact}`}>
              These cookies are necessary for the website to function and cannot be disabled:
            </p>
            <ul className={`list-disc ${spaceY.tight} ${paddingLeft.comfortable}`}>
          ...
          <div className={`${marginBottom.comfortable}`}>
            <h3 className={`${marginBottom.compact} text-xl font-semibold`}>Analytics Cookies</h3>
            <p className={`${marginBottom.compact}`}>We use privacy-focused analytics to understand usage patterns:</p>
            <ul className={`list-disc ${spaceY.tight} ${paddingLeft.comfortable}`}>
          ...
          <div className={`${marginBottom.comfortable}`}>
            <h3 className={`${marginBottom.compact} text-xl font-semibold`}>Preference Cookies</h3>
            <p className={`${marginBottom.compact}`}>These cookies remember your choices:</p>
            <ul className={`list-disc ${spaceY.tight} ${paddingLeft.comfortable}`}>
        ...
        <section className={`${marginBottom.relaxed}`}>
          <h2 className={`${marginBottom.default} text-2xl font-semibold`}>4. Third-Party Cookies</h2>
        ...
        <section className={`${marginBottom.relaxed}`}>
          <h2 className={`${marginBottom.default} text-2xl font-semibold`}>5. Managing Cookies</h2>
          <p className={`${marginBottom.default}`}>You can control and manage cookies in several ways:</p>

          <div className={`${marginBottom.default}`}>
            <h3 className={`${marginBottom.compact} text-lg font-semibold`}>Browser Settings</h3>
            <p className={`${marginBottom.compact}`}>Most browsers allow you to:</p>
            <ul className={`list-disc ${spaceY.tight} ${paddingLeft.comfortable}`}>
          ...
          <div className={`${marginBottom.default}`}>
            <h3 className={`${marginBottom.compact} text-lg font-semibold`}>Browser-Specific Instructions</h3>
            <ul className={`list-disc ${spaceY.tight} ${paddingLeft.comfortable}`}>
              <li>
        ...
        <section className={`${marginBottom.relaxed}`}>
          <h2 className={`${marginBottom.default} text-2xl font-semibold`}>6. Impact of Disabling Cookies</h2>
          <p className={`${marginBottom.default}`}>
        ...
        <section className={`${marginBottom.relaxed}`}>
          <h2 className={`${marginBottom.default} text-2xl font-semibold`}>7. Updates to This Policy</h2>
          <p className={`${marginBottom.default}`}>
        ...
        <section className={`${marginBottom.relaxed}`}>
          <h2 className={`${marginBottom.default} text-2xl font-semibold`}>8. Contact Us</h2>
          <p className={`${marginBottom.default}`}>
