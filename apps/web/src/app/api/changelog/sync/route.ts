...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const changelogEntry: Database['public']['Tables']['changelog']['Insert'] = {
      ...
      changes,
      // SEO fields are auto-generated by database trigger generate_changelog_seo_fields_trigger()
      // The trigger analyzes changes JSONB and generates: seo_title, seo_description, keywords,
      // canonical_url, og_type, twitter_card, robots_index, robots_follow
