    ...
    <div className="container-shell space-y-8 py-12">
      <div className="space-y-4 border-b border-border/80 pb-8">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <a
            href={siteConfig.polarFeaturedJobUrl}
            target={siteConfig.polarFeaturedJobUrl.startsWith("http") ? "_blank" : undefined}
            rel={siteConfig.polarFeaturedJobUrl.startsWith("http") ? "noreferrer" : undefined}
