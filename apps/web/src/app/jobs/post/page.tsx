      ...
      <div className="space-y-8">
        <div className="space-y-4 border-b border-border/80 pb-8">
          ...
          <p className="max-w-3xl text-sm leading-8 text-muted-foreground">
            This form is only for hiring roles. Tool, app, service, affiliate, and sponsored product listings belong in the tools intake flow.
          </p>
        </div>

        <section className="surface-panel space-y-4 p-6">
          <p className="text-xs uppercase tracking-[0.18em] text-primary">Selected hiring tier</p>
        ...
        <section className="surface-panel space-y-3 p-6 text-sm leading-7 text-muted-foreground">
          ...
          <p>2. We confirm fit, timing, and any placement tier before payment.</p>
          <p>3. Approved roles are published as real jobs with a detail page.</p>
          <p>
            Promoting a product instead? Use{" "}
            <Link href="/tools/submit" className="text-primary underline underline-offset-4">
