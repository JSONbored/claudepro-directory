 ...
 *     { language: 'javascript', filename: 'example.js', code: 'const x = 1;' }
 *   ]}
 * >
 *   <CodeBlockHeader>
 *     <CodeBlockFiles>
 *       {(file) => (
 *         <CodeBlockFilename value={file.language}>
 *           {file.filename}
 *         </CodeBlockFilename>
 *       )}
 *     </CodeBlockFiles>
 ...
 *         {(file) => (
 *           <CodeBlockSelectItem value={file.language}>
 *             {file.filename}
 *           </CodeBlockSelectItem>
 *         )}
 *       </CodeBlockSelectContent>
 ...
 *   <CodeBlockBody>
 *     {(file) => (
 *       <CodeBlockItem value={file.language} lineNumbers>
 ...
 * - File switching with dropdown or tabs
 * - Copy to clipboard functionality
 * - Dark mode support
 * - Line highlighting and diff support
