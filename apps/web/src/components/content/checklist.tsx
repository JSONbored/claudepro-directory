        ...
        <div className="space-y-3">
          {validItems.map((item, index) => (
            <div
              ...
              className="bg-muted/30 hover:bg-muted/50 flex items-start gap-2 rounded-lg p-3 transition-colors"
            >
              <button
                type="button"
                onClick={() => toggleItem(index)}
                className={cn('mt-[18px]', 'shrink-0')}
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  {item.priority ? (
                    <span className={`text-xs-medium ${priorityColors[item.priority]}`}>
