/**
 * OAuth 2.1 Token Revocation Endpoint - Cloudflare Workers Adapter
 *
 * Cloudflare Workers-specific adapter for OAuth token revocation.
...
import { handleOAuthRevokeShared, type OAuthAdapter } from '@heyclaude/mcp-server';
 ...
 */
export async function handleOAuthRevoke(request: Request, env: ExtendedEnv): Promise<Response> {
