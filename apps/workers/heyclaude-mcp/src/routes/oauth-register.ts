/**
 * OAuth 2.1 Dynamic Client Registration Endpoint - Cloudflare Workers Adapter
 *
 * Cloudflare Workers-specific adapter for OAuth dynamic client registration.
...
import { handleOAuthRegisterShared, type OAuthAdapter } from '@heyclaude/mcp-server';
 ...
 */
export async function handleOAuthRegister(request: Request, env: ExtendedEnv): Promise<Response> {
