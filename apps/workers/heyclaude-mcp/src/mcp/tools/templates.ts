...
import type { GetTemplatesInput } from '../../lib/types';
  ...
  try {
    ...
    if (templatesArray.length === 0) {
      ...
      logger.info(
        ...
        'getTemplates completed with no results'
      );
    ...
    logger.error({ error: normalized, tool: 'getTemplates', category }, 'getTemplates tool error');
    throw normalized;
  }
}
